...
A Laravel-based web application for managing agricultural commodities trading, transport logistics, customer relationships, and financial transactions.
...
- `TradeRule` / `TradeRuleOpp` - Trading rules
- `ContractSummary` / `ContractType` - Contract management
