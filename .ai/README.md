...
This directory contains comprehensive documentation to help AI assistants understand and work with the SilverGro project
effectively.
...
**Purpose:** Comprehensive guide to the approval system for PC, SC, and MQ contracts  
**Use when:** Working with contract approvals, understanding approval numbers (a_pc, a_sc, a_mq), or implementing
approval-related features

**Contains:**

- Contract type definitions (Direct, PC, SC, MQ)
- PC/SC approval workflow (simplified)
- MQ approval workflow (complex with trade rules)
- Database fields and migrations
- Frontend implementation details
- Backend controller logic
- Display patterns across views
- Search and filtering implementation
- State management for approval forms
- Routes and guards
- Testing checklist
...
**Remember:** These documentation files are designed to make AI assistance more effective and accurate. Always provide
relevant context from these files when requesting help!
