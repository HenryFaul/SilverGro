                    ...
                    <table class="table_sections" style="width:100%;">
                        ...
                        <tr class="table_sections">
                            ...
                            <td class="table_sections table_row_value" colspan="3">
                                @if(!is_countable(optional($transport_trans->Supplier)->addressablePhysical) || count(optional($transport_trans->Supplier)->addressablePhysical) === 0)
                        ...
                        <tr class="table_sections">
                            ...
                            <td class="table_sections table_row_value" colspan="3">
                                ...
                                @if(optional(optional($transport_trans->TransportLoad)->CollectionAddress)->line_2)
                                    ,
                                    <span>{{optional(optional($transport_trans->TransportLoad)->CollectionAddress)->line_2}}</span>
                                @endif

                                @if(optional(optional($transport_trans->TransportLoad)->CollectionAddress)->line_3)
                                    ,
                                    <span>{{optional(optional($transport_trans->TransportLoad)->CollectionAddress)->line_3}}</span>
                                @endif
