            ...
            <ol type="1">
                ...
                @if($transport_trans->is_split_load)
                    ...
                    <div>
                        <table class="table_sections" style="width:100%;">
                            ...
                            <tr class="table_sections">
                                ...
                                <td class="table_sections table_row_value"
                                    style="width: 20%;">Split supplier...</td>
                    ...
                    @if(isset($split_data))
                        ...
                        <div>
                            <table class="table_sections" style="width:100%;">
                                ...
                                <tr class="table_sections">
                                    ...
                                    <td style="width: 10%;" class="table_sections table_row_heading">Supplier Order #</td>
                                    ...
                                    <td style="width: 10%;" class="table_sections table_row_heading">Cust Offloading #</td>
                        ...
                        <div>
                            ...
                            <table class="table_sections" style="width:100%;">
                                ...
                                <tr class="table_sections">
                                    ...
                                    <td style="width: 12.5%;" class="table_sections table_row_heading">Billing Units</td>
                                    <td style="width: 12.5%;" class="table_sections table_row_heading">Packaging Incoming </td>
                                    <td style="width: 12.5%;  text-align: center;" class="table_sections table_row_heading">BU In
                                    </td>
                                    <td style="width: 12.5%; text-align: right;" class="table_sections table_row_heading">Cost PU</td>
                                    <td style="width: 12.5%; text-align: right;" class="table_sections table_row_heading">Cost PT</td>
                                    <td style="width: 12.5%;  text-align: center;" class="table_sections table_row_heading">Planned TI</td>
                                    <td style="width: 12.5%; text-align: right;" class="table_sections table_row_heading">Transport Rate</td>
                                    <td style="width: 12.5%; text-align: right;" class="table_sections table_row_heading">Load Rate</td>
                                    <td style="width: 12.5%; text-align: right;" class="table_sections table_row_heading">Effective Rate/Ton </td>
                                    <td style="width: 12.5%;  text-align: center;" class="table_sections table_row_heading">Planned TO</td>
                                    <td style="width: 12.5%; text-align: right;" class="table_sections table_row_heading">Selling Ton</td>
                                    <td style="width: 12.5%; text-align: right;" class="table_sections table_row_heading">GP</td>
                                ...
                                @foreach ($split_data['linked_trans_split'] as $deal)
                                    ...
                                    <tr class="table_sections" style="width:100%;">
                                        ...
                                        <td style="width: 12.5%; text-align: right;"
                                            class="table_sections table_row_value">R{{number_format(round($deal->TransportTransaction->TransportFinance->cost_price_per_unit,2), 2, '.', ' ')}}</td>
                                        <td style="width: 12.5%; text-align: right;"
                                            class="table_sections table_row_value">R{{number_format(round($deal->TransportTransaction->TransportFinance->cost_price_per_ton,2), 2, '.', ' ')}}</td>

                                        <td style="width: 12.5%;  text-align: center;"
                                            class="table_sections table_row_value">{{$deal->TransportTransaction->TransportFinance->weight_ton_incoming}}</td>

                                        <td style="width: 12.5%; text-align: right;"
                                            class="table_sections table_row_value">R {{number_format(round($deal->TransportTransaction->TransportFinance->transport_rate_per_ton,2), 2, '.', ' ')}}</td>
                                        <td style="width: 12.5%; text-align: right;"
                                            class="table_sections table_row_value">{{$deal->TransportTransaction->TransportFinance->TransportRateBasis->name}}</td>
                                        <td style="width: 12.5%; text-align: right;"
                                            class="table_sections table_row_value">R {{number_format(round($deal->TransportTransaction->TransportFinance->transport_cost,2), 2, '.', ' ')}}</td>
                                        <td style="width: 12.5%;  text-align: center;"
                                            class="table_sections table_row_value">{{$deal->TransportTransaction->TransportFinance->weight_ton_outgoing}}</td>
                                        <td style="width: 12.5%; text-align: right;"
                                            class="table_sections table_row_value">R {{number_format(round($deal->TransportTransaction->TransportFinance->selling_price_per_ton,2), 2, '.', ' ')}}</td>
                                        <td style="width: 12.5%; text-align: right;"
                                            class="table_sections table_row_value"> R {{number_format(round($deal->TransportTransaction->TransportFinance->gross_profit_per_ton,2), 2, '.', ' ')}}</td>
                                    </tr>
                                ...
                                <tr class="table_sections">
                                    ...
                                    <td class="table_sections table_row_heading"></td>
                                    <td class="table_sections table_row_heading"></td>
                                    <td style=" text-align: center;" class="table_sections table_row_heading">{{ number_format($total_units_incoming, 0, '.', ' ') }}</td>
                                    <td class="table_sections table_row_heading"></td>
                                    <td class="table_sections table_row_heading"></td>
                                    <td style=" text-align: center;" class="table_sections table_row_heading">{{ number_format($total_weight_ton_incoming, 0, '.', ' ') }}</td>
                                    <td class="table_sections table_row_heading"></td>
                                    <td class="table_sections table_row_heading"></td>
                                    <td class="table_sections table_row_heading"></td>
                                    <td style=" text-align: center;" class="table_sections table_row_heading">{{ number_format($total_weight_ton_outgoing, 0, '.', ' ') }}</td>
                                    <td class="table_sections table_row_heading"></td>
                                    <td class="table_sections table_row_heading"></td>
                                </tr>
                        ...
                        <div class="table_row_heading">Supplier notes:</div>
                                    ...
                                    @foreach ($split_data['linked_trans_split'] as $deal)
                                        ...
                                        <tr class="table_sections">
                                            ...
                                            <td style="border: 1px solid black;" class="table_sections table_row_value"
                                                colspan="3">{!! nl2br($deal->TransportTransaction->supplier_notes) !!}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                    ...
                    @if(isset($split_data))
                        ...
                        <div>
                            ...
                            <div>
                                <br>
                                <br>
                                <li class="section_heading mt-2">Product info [MQ{{$deal->TransportTransaction->a_mq}}]</li>
                                <div class="mt-2">
                                ...
                                <div>
                                    <table class="table_sections" style="width:100%;">
                                        ...
                                        <tr class="table_sections">
                                            ...
                                            <td class="table_sections table_row_heading" style="width: 25%;">VAT cert.
                                                received
                                            </td>
                                            <td class="table_sections table_row_value" style="width: 25%;">
                                        ...
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width: 25%;">Silvergro
                                                Linked SC #
                                            </td>
                                ...
                                <div>
                                    ...
                                    <table class="table_sections" style="width:50%;">
                                        <tbody>
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width: 50%;">Transporter
                                                Name
                                            </td>
                                            <td class="table_sections table_row_value"
                                        ...
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width: 50%;">Driver Name
                                            </td>
                                            <td class="table_sections table_row_value"
                                        ...
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width: 50%;">Driver cell
                                            </td>
                                            <td class="table_sections table_row_value"
                                                colspan="3">{{$deal->TransportTransaction->TransportJob->TransportDriverVehicle[0]->Driver->cell_no}} </td>
                                        </tr>
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width: 50%;">Weight Tons
                                                Incoming
                                            </td>
                                            <td class="table_sections table_row_value"
                                                style="width: 25%;"
                                    ...
                                    <table class="table_sections" style="width:100%;">
                                        ...
                                        <tr class="table_sections">
                                            ...
                                            <td class="table_sections table_row_heading" style="width: 25%;">Rate / Ton
                                            </td>
                                            <td class="table_sections table_row_value" style="width: 25%;">
                                        ...
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width: 25%;">Load Tarrif
                                                (B)
                                            </td>
                                            <td class="table_sections table_row_value">
                                ...
                                <div>
                                    ...
                                    <table class="table_sections" style="width:50%;">
                                        ...
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width:50%;">Cost Price /
                                                Unit
                                            </td>
                                            <td class="table_sections table_row_value"
                                                style="background-color: #62FD473F">
                                        ...
                                        <tr class="table_sections">
                                            <td class="table_sections table_row_heading" style="width:50%;">Total cost
                                            </td>
                                            <td class="table_sections table_row_value"
                                                style="background-color: #62FD473F">
                                ...
                                <div>
                                    <table class="table_sections" style="width:100%;">
                                        ...
                                        <tr class="table_sections">
                                            ...
                                            <td class="table_sections table_row_heading" style="width: 25%;">Additional
                                                Cost
                                                1
                                            </td>
                                            <td class="table_sections table_row_value" style="width: 25%;">
