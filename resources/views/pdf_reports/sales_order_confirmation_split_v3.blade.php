                            ...
                            <div>
                                <table class="table_sections" style="width:100%;">
                                    ...
                                    <tr class="table_sections">
                                        ...
                                        <td class="table_sections table_row_value" colspan="3">
                                            @if($deal->TransportTransaction->Customer->contactable->where('is_active', 1)->isEmpty())
                                                <span>No contact loaded</span>
                                            @else
                                                @foreach($deal->TransportTransaction->Customer->contactable->where('is_active', 1) as $contact)
                                                    <div>
