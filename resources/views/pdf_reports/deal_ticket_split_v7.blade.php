                            ...
                            <div>
                                <table class="table_sections" style="width:100%;">
                                    ...
                                    <tr class="table_sections">
                                        ...
                                        <td class="table_sections table_row_value" colspan="3">
                                            <span>{{ optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->line_1 }}</span>
                                            @if(optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->line_2)
                                                ,
                                                <span>{{ optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->line_2 }}</span>
                                            @endif
                                            @if(optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->line_3)
                                                ,
                                                <span>{{ optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->line_3 }}</span>
                                            @endif
                                            @if(optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->country)
                                                ,
                                                <span>{{ optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->country }}</span>
                                            @endif
                                            @if(optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->code)
                                                ,
                                                <span>{{ optional(optional($deal->TransportTransaction->TransportLoad)->CollectionAddress)->code }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr class="table_sections">
