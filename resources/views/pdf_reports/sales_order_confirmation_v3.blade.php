...
<head>
    ...
    <title>{{ $transport_trans->contract_type_id == 3 ? 'Sales Contract' : 'Sales Order Confirmation' }}</title>
    <style>
        @page {
    ...
    <div style="">
        ...
        <div style="margin-top: 5px;">
            ...
            <ol type="1">
                ...
                <div>
                    <table class="table_sections" style="width:100%;">
                        ...
                        <tr class="table_sections">
                            ...
                            <td class="table_sections table_row_value" colspan="3">
                                @if($transport_trans->Customer->contactable->where('is_active', 1)->isEmpty())
                                    <span>No contact loaded</span>
                                @else
                                    @foreach($transport_trans->Customer->contactable->where('is_active', 1) as $contact)
                                        <div>
                    ...
                    <p class="table_row_value">
                        Herewith our confirmation of the <strong>{{ $transport_trans->contract_type_id == 3 ? 'SALES CONTRACT' : 'SALES ORDER' }}</strong> for the following product,
                ...
                <div>
                    <table class="table_sections" style="width:100%;">
                        ...
                        <tr class="table_sections">
                            ...
                            <td class="table_sections table_row_value" style="width: 25%;">
                                @if($transport_trans->TransportJob && isset($transport_trans->TransportJob->TransportDriverVehicle[0])){{$transport_trans->TransportJob->TransportDriverVehicle[0]->driver_vehicle_loading_number ?? ''}}@endif
                            </td>
                        </tr>
                ...
                <div class="table_row_value">
                    The buyer accepts the conditions as set out in this "{{ $transport_trans->contract_type_id == 3 ? 'SALES CONTRACT' : 'SALES ORDER' }}", unless changes are presented in
