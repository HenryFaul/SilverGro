            ...
            <ol type="1">
                ...
                <div>
                    <table class="table_sections" style="width:100%;">
                        ...
                        <tr class="table_sections">
                            <td class="table_sections table_row_heading" style="width: 25%;">Cost Price / Metric Ton
                            </td>
                            <td class="table_sections table_row_value">
                    ...
                    @if($transport_trans->Customer_2->last_legal_name != 'Unallocated')
                        <div>
                            <table class="table_sections" style="width:100%;">
                                <tbody>
                                <tr class="table_sections">
                                    <td class="table_sections table_row_heading" style="width: 25%;">Split Customer 2
                                    </td>
                                    <td class="table_sections table_row_value"
                                        colspan="3">{{$transport_trans->Customer_2->last_legal_name}}</td>
                                </tr>
                                <tr class="table_sections">
                                    <td class="table_sections table_row_heading" style="width: 25%;">Delivery Address
                                    </td>
                                    <td class="table_sections table_row_value" colspan="3">
                                    <span>
                                ...
                                <tr class="table_sections">
                                    ...
                                    <td class="table_sections table_row_heading" style="width: 25%;">Transport Cost
                                        Split
                                    </td>
                                    <td class="table_sections table_row_value">
                        ...
                        <div>
                            <table class="table_sections" style="width:100%;">
                                ...
                                <tr class="table_sections">
                                    ...
                                    <td class="table_sections table_row_heading" style="width: 25%;">Customer order no
                                    </td>
                                    <td class="table_sections table_row_value">
                                        {{$transport_trans->TransportJob->customer_order_number_2}}
                                    </td>
                ...
                <div class="">
                    ...
                    @if(str_contains(strtolower($transport_trans->product->name), 'bagged'))
                        ...
                        <div class="table_row_value">
                            Driver and Customer to do a bag count and sign for goods on the transporters delivery
