                ...
                @if($transport_trans->is_split_load)
                    ...
                    @if(isset($split_data))
                        ...
                        @foreach ($split_data['linked_trans_split'] as $deal)
                            ...
                            <li class="section_heading">Supplier Details [MQ{{$deal->TransportTransaction->a_mq}}]</li>
                            <div>
                            ...
                            <div>
                                <table class="table_sections" style="width:100%;">
                                    ...
                                    <tr class="table_sections">
                                        ...
                                        <td class="table_sections table_row_value">{{$deal->TransportTransaction->TransportLoad->PackagingIncoming->name}}</td>
                                    ...
                                    <tr class="table_sections">
                                        ...
                                        <td class="table_sections table_row_value">
                                            @if($deal->TransportTransaction->Supplier->is_vat_exempt)
                                                Yes
                                            @else
                                                No
                                            @endif
                                    ...
                                    <tr class="table_sections">
                                        <td class="table_sections table_row_heading" style="width: 25%;">Total Cost
                                            Price
                                        </td>
                                        <td class="table_sections table_row_value">
                                        ...
                                        <td class="table_sections table_row_value">{{$deal->TransportTransaction->Supplier->TermsOfPayment->value}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
