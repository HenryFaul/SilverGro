                ...
                <div>
                    <table class="table_sections" style="width:100%;">
                        ...
                        <tr class="table_sections">
                            ...
                            <td class="table_sections table_row_value" colspan="3">
                                @if($transport_trans->Transporter->contactable->where('is_active', 1)->isEmpty())
                                    <span>No contact loaded</span>
                                @else
                                    @foreach($transport_trans->Transporter->contactable->where('is_active', 1) as $contact)
                                        <div>
                ...
                <div>
                    <table class="table_sections" style="width:100%;">
                        ...
                        <tr class="table_sections">
                            ...
                            <td class="table_sections table_row_heading" style="width: 25%;">Trailer #2 Reg.</td>
                            <td class="table_sections table_row_value" style="width: 25%;">
                ...
                <div class="">
                    <table class="table_sections" style="width:100%;">
                        ...
                        <tr class="table_sections">
                            ...
                            <td class="table_sections table_row_heading" style="width: 25%;">Customer order number
                            </td>
                            <td class="table_sections table_row_value">
