...
<template>
  <tr :class="rowClasses" @click="handleClick">
    <!-- ID Column -->
    <td :class="cellClass">
      <div v-if="transaction.a_mq" class="text-lg font-bold text-black">
        MQ{{ transaction.a_mq }}
      </div>
      ...
      <div v-if="transaction.old_id" class="font-light text-sm italic">
    ...
    <!-- Deal Ticket (D/T) -->
    <td v-if="showDetails && transaction.deal_ticket" :class="cellClass">
      <check-icon
    ...
    <!-- Purchase Order (P/O) -->
    <td v-if="showDetails && transaction.purchase_order" :class="cellClass">
      <check-icon
    ...
    <!-- Sales Order (S/O) -->
    <td v-if="showDetails && transaction.sales_order" :class="cellClass">
      <check-icon
    ...
    <!-- Transport Order (T/O) -->
    <td v-if="showDetails && transaction.transport_order" :class="cellClass">
      <check-icon
    ...
    <!-- Weighbridge (WB) -->
    <td v-if="showDetails && transaction.transport_load" :class="cellClass">
      <check-icon
    ...
    <!-- Invoice (INV) -->
    <td v-if="showDetails && transaction.transport_invoice" :class="cellClass">
      <check-icon
