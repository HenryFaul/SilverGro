      ...
      <div
        ...
        <span class="flex items-center">
          <icon
            ...
            name="arrow-split" />
          <span
            v-if="transaction.contract_type?.name === 'MQ' && (transaction.a_mq || transaction.old_deal_ticket)"
            class="font-bold">
            (MQ:{{ transaction.a_mq ?? transaction.old_deal_ticket }})
          </span>
          <span
            v-if="transaction.contract_type?.name === 'PC' && (transaction.a_pc || transaction.contract_no)"
            class="font-bold">
            (PC:{{ transaction.a_pc ?? transaction.contract_no }})
          </span>
          <span
            v-if="transaction.contract_type?.name === 'SC' && (transaction.a_sc || transaction.contract_no)"
            class="font-bold">
