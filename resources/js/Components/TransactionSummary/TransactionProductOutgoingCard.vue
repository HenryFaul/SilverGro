    ...
    <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
      ...
      <div class="flex justify-between gap-x-4 py-3">
        ...
        <dd class="flex items-start gap-x-2">
          <Combobox as="div" v-model="combinedForm.billing_units_outgoing_id">
            <div class="relative mt-2">
              <ComboboxInput
                ...
                @change="
                  $emit('update:billingUnitsOutgoingQuery', $event.target.value)
                "
      ...
      <div class="flex justify-between gap-x-4 py-3">
        ...
        <dd class="flex items-start gap-x-2">
          <Combobox as="div" v-model="combinedForm.packaging_outgoing_id">
            <div class="relative mt-2">
              <ComboboxInput
                class="w-48 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                @change="
                  $emit('update:packageOutgoingQuery', $event.target.value)
                "
