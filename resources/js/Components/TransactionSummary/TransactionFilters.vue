  ...
  <div class="ml-4 grid grid-cols-1 gap-x-6 gap-y-1 sm:grid-cols-6">
    ...
    <div class="flex col-span-6">
      ...
      <div class="mt-5 ml-1">
        ...
        >
          ...
          <option v-for="n in contractTypesArray" :key="n.id" :value="n.id">
            {{ n.name }}
          </option>
        </select>
      </div>
    ...
    <div class="col-span-4 flex">
      ...
      <div>
        ...
        <secondary-button class="ml-1" @click="emit('clear')">
          Clear
        </secondary-button>
        <secondary-button class="ml-1" @click="emit('add-trade')">
          Add (+)
        </secondary-button>
        <secondary-button class="ml-1" @click="emit('toggle-details')">
          Toggle
        </secondary-button>
      </div>
