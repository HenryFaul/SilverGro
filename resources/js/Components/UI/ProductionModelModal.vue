...
const update = () =>
  modelUpdateForm.put(
    route('production-model.update', {
      production_model: props.ProductionModel.id,
    }),
    {
      preserveScroll: false,
      onSuccess: () => {
        modelUpdateForm.reset();
        close();
      },
    }
  );
...
const deleteModel = () => {
  if (confirm('Sure you want to delete: ' + props.ProductionModel.model_name)) {
    modelUpdateForm.delete(
      route('production-model.destroy', {
        production_model: props.ProductionModel.id,
      }),
      {
        preserveScroll: false,
          ...
          <form @submit.prevent="submitForm">
            <div class="grid grid-cols-6 gap-4">
              <div class="col-span-4">
                ...
                >
                <input
                  v-model="modelUpdateForm.model_name"
                  type="text"
                ...
                <InputError
                  class="mt-2"
                  :message="modelUpdateForm.errors.model_name"
                />
              </div>
              ...
              <div class="col-span-4">
                ...
                >
                <select
                  v-model="modelUpdateForm.flex_type_id"
                  class="input-filter-l w-full rounded-md rounded-md shadow-sm border border-gray-300"
                >
                  <option v-for="n in flex_types" :key="n.id" :value="n.id">
                    {{ n.flex_name }}
                  </option>
                </select>
                ...
                <InputError
                  class="mt-2"
                  :message="modelUpdateForm.errors.flex_type_id"
                />
              </div>
              ...
              <div class="col-span-4">
                ...
                >
                <input
                  v-model="modelUpdateForm.reference_id"
                  type="text"
                  class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500"
                />
                ...
                <InputError
                  class="mt-2"
                  :message="modelUpdateForm.errors.reference_id"
                />
              </div>
              ...
              <div class="col-span-4">
                ...
                >
                <input
                  v-model="modelUpdateForm.comment"
                  type="text"
                  class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500"
                />
                <InputError
                  class="mt-2"
                  :message="modelUpdateForm.errors.comment"
                />
              </div>
              ...
              <div class="col-span-4">
                ...
                >
                <select
                  v-model="modelUpdateForm.is_active"
                  class="input-filter-l w-2/3 rounded-md rounded-md shadow-sm border border-gray-300"
                >
                ...
                <InputError
                  class="mt-2"
                  :message="modelUpdateForm.errors.is_active"
                />
              </div>
            </div>
          </form>
