...
const updateDriverVehicle = () => {
  form.put(
    route('transport_driver_vehicle.update.state', props.driver_vehicle.id),
    {
      preserveScroll: true,
      onSuccess: () => {
        close();
  ...
  <div>
              ...
              <div class="mt-3">
                <div class="flex col-span-2 mt-2">
                  <SwitchGroup as="div" class="flex m-2 items-center">
                    <Switch
                      @update:modelValue="updateDriverVehicle"
    ...
    <div>
      <div v-if="props.driver_vehicle == null">
        <div>Missing driver vehicle. Contact support.</div>
      </div>
      <div v-else>
