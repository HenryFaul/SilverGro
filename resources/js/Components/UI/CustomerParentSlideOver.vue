...
const createCustomer= () => {
    ...
    customerForm.post(route('customer_parent.store'), {
        preserveScroll: true,
        onSuccess: () => {
            close();
        },
                                        ...
                                        <div class="flex-1">
                                                ...
                                                <div class="flex items-start justify-between space-x-3">
                                                    <div class="space-y-1">
                                                        ...
                                                        <p class="text-sm text-gray-500">Complete the Required details
                                                            to load a new Customer Parent.</p>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="customerForm.last_legal_name" type="text" name="first_name" id="last_legal_name"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="customerForm.nickname" type="text" name="first_name" id="nickname"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="customerForm.id_reg_no" type="text" name="first_name" id="id_reg_no"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
