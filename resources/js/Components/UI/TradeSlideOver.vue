...
const getComponentProps = () => {
  ...
  axios.get(route('props.trade_slide_over')).then((res) => {
    ...
    form.supplier_id = res.data['suppliers'].find(
      (element) => element.id === 1
    );
    form.customer_id = res.data['customers'].find(
      (element) => element.id === 1
    );
    form.transporter_id = res.data['transporters'].find(
      (element) => element.id === 1
    );
                        ...
                        <div class="flex items-start justify-between space-x-3">
                          <div class="space-y-1">
                            ...
                            <p class="text-sm text-gray-500">
                              Complete the Required details to load a new trade.
                            </p>
                          </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="sm:col-span-2">
                            <div v-if="tradeSlideProps != null" class="mt-2">
                              ...
                              <InputError
                                class="mt-2"
                                :message="form.errors['contract_type_id.id']"
                              />
                            </div>
                            <div v-else>null</div>
                          </div>
                        ...
                        >
                          ...
                          <div class="sm:col-span-2">
                            <div v-if="tradeSlideProps != null" class="mt-2">
                              ...
                              <InputError
                                class="mt-2"
                                :message="form.errors.transporter_id"
                              />
                            </div>
                            <div v-else>null</div>
                          </div>
                        ...
                        >
                          ...
                          <div class="sm:col-span-2">
                            <div v-if="tradeSlideProps != null" class="mt-2">
                              ...
                              <InputError
                                class="mt-2"
                                :message="form.errors['product_id.id']"
                              />
                            </div>
                            <div v-else>null</div>
                          </div>
                        ...
                        >
                          ...
                          <div class="sm:col-span-2">
                            <div v-if="tradeSlideProps != null" class="mt-2">
                              ...
                              <InputError
                                class="mt-2"
                                :message="form.errors['billing_units_id.id']"
                              />
                            </div>
                            <div v-else>null</div>
                          </div>
                        ...
                        >
                          ...
                          <div class="sm:col-span-2">
                            <div v-if="tradeSlideProps != null" class="mt-2">
                              <select
                                v-model="form.transport_rate_basis_id"
                              ...
                              <InputError
                                class="mt-2"
                                :message="form.errors.transport_rate_basis_id"
                              />
                            </div>
                            <div v-else>null</div>
                          </div>
