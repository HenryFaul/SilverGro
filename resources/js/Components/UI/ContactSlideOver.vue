                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="contactForm.last_legal_name" type="text" name="first_name" id="last_legal_name"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="contactForm.nickname" type="text" name="first_name" id="nickname"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="contactForm.id_reg_no" type="text" name="first_name" id="id_reg_no"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
