...
const form = useForm({
  ...
  transport_job_id:
    props.transport_job_id == null ? null : props.transport_job_id,
  regular_driver_id:
  ...
  weighbridge_upload_weight:
    props.driver_vehicle == null
      ? 0
      : props.driver_vehicle.weighbridge_upload_weight,
  weighbridge_offload_weight:
    props.driver_vehicle == null
      ? 0
      : props.driver_vehicle.weighbridge_offload_weight,
  is_weighbridge_variance:
    props.driver_vehicle == null
      ? false
      : props.driver_vehicle.is_weighbridge_variance,
  is_cancelled:
  ...
  is_loaded:
    props.driver_vehicle == null ? false : props.driver_vehicle.is_loaded,
  date_loaded:
    props.driver_vehicle == null ? null : props.driver_vehicle.date_loaded,
  is_onroad:
    props.driver_vehicle == null ? false : props.driver_vehicle.is_onroad,
  date_onroad:
    props.driver_vehicle == null ? null : props.driver_vehicle.date_onroad,
  is_delivered:
  ...
  is_transport_scheduled:
    props.driver_vehicle == null
      ? false
      : props.driver_vehicle.is_transport_scheduled,
  date_scheduled:
  ...
  date_paid:
    props.driver_vehicle == null ? null : props.driver_vehicle.date_paid,
  is_payment_overdue:
    props.driver_vehicle == null
      ? false
      : props.driver_vehicle.is_payment_overdue,
  traders_notes:
    props.driver_vehicle == null ? null : props.driver_vehicle.traders_notes,
  operations_alert_notes:
    props.driver_vehicle == null
      ? null
      : props.driver_vehicle.operations_alert_notes,
...
const deleteDriverVehicle = () => {
  if (confirm('Sure you want to delete?')) {
    form.delete(
      route('transport_driver_vehicle.destroy', props.driver_vehicle.id),
      {
        preserveScroll: true,
        onSuccess: () => {
          close();
...
<template>
  <div>
    <dialog-modal :show="show" :closeable="closeable" @close="close">
      <template #content>
        <div>
          <div class="">
              ...
              <div :class="borderClass">
                ...
                <div class="mt-3">
                  <label
                    ...
                    >Driver/Vehicle loading no</label
                  >
                  <TextInput
                    id="loading_no"
                ...
                <div class="mt-3">
                  <label
                    class="block text-sm font-medium leading-6 text-gray-900"
                    >weighbridge_upload_weight</label
                  >
                  <TextInput
                    id="line_1"
                ...
                <div class="mt-3">
                  <label
                    class="block text-sm font-medium leading-6 text-gray-900"
                    >weighbridge_offload_weight</label
                  >
                  <TextInput
      ...
      <template #footer>
        ...
        <SecondaryButton class="ml-1" @click="close"> Close </SecondaryButton>
      </template>
    </dialog-modal>
  </div>
</template>
