...
<!--                            'transport_trans_id','transport_job_id','regular_driver_id','regular_vehicle_id','weighbridge_upload_weight','weighbridge_offload_weight',
                            ...
                            <div v-if="link_type_id ===3" class="text-xl mb-2 text-indigo-400">Link MQ to PC</div>
                            <div v-else-if="link_type_id ===4" class="text-xl mb-2 text-indigo-400">Link MQ to SC</div>
                            ...
                            <div :class="borderClass">
                                ...
                                <div v-else-if="link_type_id ===4">
                                    <div class="mt-3">
                                        ...
                                        <div>
                                            <label
                                                class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5">SC contracts:</label>
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="m-3 p-3">
                                            <div>
                                                <div class="px-4 sm:px-0">
                                                    <h3 class="text-base font-semibold leading-7 text-gray-900">SC Contract details</h3>
                                                    <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Selected SC will be linked to the underlying MQ.</p>
                                                </div>
                                                <div class="mt-6 border-t border-gray-100">
                                                    <dl class="divide-y divide-gray-100">
