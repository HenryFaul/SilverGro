      ...
      <template #content>
        <div>
          <div
            class=""
            v-if="
              contractLinkModalProps != null && contractLinkModalPropsSc != null
            "
          >
            <form class="w-full">
              ...
              <div
                v-if="link_type_id === 3"
                class="text-xl mb-2 text-indigo-400"
              >
                Link MQ to PC
              </div>
              <div
                v-else-if="link_type_id === 4"
                class="text-xl mb-2 text-indigo-400"
              >
                Link MQ to SC
              </div>
              <div v-else class="text-xl mb-2 text-indigo-400">Other</div>

              <div :class="borderClass">
                <div class="mt-3"></div>

                <div v-if="link_type_id === 3">
                  <div class="mt-3">
                    <div>
                      <label
                    ...
                    <div class="m-1 p-1">
                      <div>
                        <div class="px-4 sm:px-0">
                          ...
                          >
                            Selected PC will be linked to the underlying MQ.
                          </p>
                        </div>
                        <div class="mt-6 border-t border-gray-100">
                          <dl class="divide-y divide-gray-100">
                            ...
                            >
                              ...
                              >
                                {{ form.to_link_id.customer.last_legal_name }}
                              </dd>
                            </div>
                            ...
                            >
                              ...
                              <dd
                                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
                              >
                                {{ form.to_link_id.supplier.last_legal_name }}
                              </dd>
                            </div>
                            <div
                              class="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0"
                            ...
                            >
                              ...
                              <dd
                                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
                              >
                                {{ form.to_link_id.transport_date_earliest }}
                              </dd>
                            </div>
                            <div
                              class="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0"
                            ...
                            >
                              ...
                              >
                                {{
                                  form.to_link_id.transport_load
                                    .no_units_incoming
                                }}
                              </dd>
                            </div>
                ...
                <div v-else-if="link_type_id === 4">
                  <div class="mt-3">
                    ...
                    <Combobox as="div" v-model="form.to_link_id_sc">
                      <div class="relative mt-2">
                        <ComboboxInput
                          class="w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      ...
                      <div>
                        <div class="px-4 sm:px-0">
                          ...
                          <p
                            class="mt-1 max-w-2xl text-sm leading-6 text-gray-500"
                          >
                            Selected SC will be linked to the underlying MQ.
                          </p>
                        </div>
                        <div class="mt-6 border-t border-gray-100">
                          <dl class="divide-y divide-gray-100">
                            ...
                            >
                              ...
                              >
                                {{
                                  form.to_link_id_sc.customer.last_legal_name
                                }}
                              </dd>
                            </div>
                            ...
                            >
                              ...
                              >
                                {{
                                  form.to_link_id_sc.supplier.last_legal_name
                                }}
                              </dd>
                            </div>
                            ...
                            >
                              ...
                              <dd
                                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
                              >
                                {{ form.to_link_id_sc.transport_date_earliest }}
                              </dd>
                            </div>
                            <div
                              class="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0"
                            >
                              ...
                              <dd
                                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
                              >
                                {{ form.to_link_id_sc.product.name }}
                              </dd>
                            </div>
                            <div
                              class="px-4 py-1 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0"
                            >
                              ...
                              >
                                {{
                                  form.to_link_id_sc.transport_load
                                    .no_units_incoming
                                }}
                              </dd>
                            </div>
