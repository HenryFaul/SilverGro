...
const createTransporter = () => {
    ...
    Form.post(route('transporter.store'), {
        preserveScroll: true,
        onSuccess: () => {
            close();
        },
                                    ...
                                    <form class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="Form.first_name" type="text" name="first_name" id="first_name" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="Form.last_legal_name" type="text" name="first_name" id="last_legal_name"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="Form.nickname" type="text" name="first_name" id="nickname"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <input v-model="Form.id_reg_no" type="text" name="first_name" id="id_reg_no"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                        ...
                                        <div class="flex-shrink-0 border-t border-gray-200 px-4 py-5 sm:px-6">
                                            <div class="flex justify-end space-x-3">
                                                ...
                                                <button type="button" @click="createTransporter"
