...
const classesTransporters = computed(() => {
  return route().current('regular_driver.*') ||
    route().current('transporter.*') ||
    route().current('regular_vehicle.*')
    ? 'border-b-2 border-indigo-400 font-semibold text-black text-sm  focus:outline-none focus:border-indigo-700 transition'
    : 'font-semibold text-black text-sm';
});

const classesSystemPlayer = computed(() => {
  return route().current('customer.*') ||
    route().current('contact.*') ||
    route().current('supplier.*') ||
    route().current('transporter.*') ||
    route().current('customer_parent.*')
    ? 'border-b-2 border-indigo-400 font-semibold text-black text-sm focus:outline-none focus:border-indigo-700 transition'
    : 'font-semibold text-black text-sm';
});

const classesViews = computed(() => {
  return route().current('planning.diary') ||
    route().current('planning.week') ||
    route().current('transaction_spreadsheet.index') ||
    route().current('debtor.*') ||
    route().current('pc_overview.index') ||
    route().current('sc_overview.index') ||
    route().current('home_overview.index')
    ? 'border-b-2 border-indigo-400 font-semibold text-black text-sm  focus:outline-none focus:border-indigo-700 transition'
    : 'font-semibold text-black text-sm';
});
...
const classesReports = computed(() => {
  return route().current('custom_report.*') ||
    route().current('transport_transaction.*')
    ? 'border-b-2 border-indigo-400 font-semibold text-black text-sm  focus:outline-none focus:border-indigo-700 transition'
    : 'font-semibold text-black text-sm';
});

const classesPlanning = computed(() => {
  return route().current('planning.*') ||
    route().current('transport_transaction.*')
    ? 'border-b-2 border-indigo-400 font-semibold text-black text-sm  focus:outline-none focus:border-indigo-700 transition'
    : 'font-semibold text-black text-sm';
});
...
const unread_notifications = computed(() =>
  Math.min(usePage().props.unread_notification_count, 9)
);
</script>
  ...
  <div>
    ...
    <div class="min-h-screen bg-gray-100">
      <nav class="bg-white border-b border-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-3 lg:px4">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
              ...
              >
                <div class="relative p-1">
                  ...
                  <div
                    class="absolute right-0 top-0 h-4 w-4 bg-red-500 text-white font-medium border border-white rounded-full text-xs text-center"
                  >
            ...
            <div>
              <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div :class="classesSuppliers">
                  <Link :class="btnSetup" :href="route('supplier.index')"
                    >Suppliers</Link
                  >
                </div>
                ...
                <div :class="classesProducts">
                  <Link :class="btnSetup" :href="route('product.index')"
                    >Products</Link
                  >
                </div>
                ...
                <div :class="classesTransSummary">
                  <Link
                    :class="btnSetup"
                    :href="route('transaction_summary.index')"
                    >Trades</Link
                  >
                </div>
                  ...
                  <div :class="classesViews">
                    <Dropdown align="right" width="48">
                      ...
                      <template #content>
                        ...
                        <DropdownLink
                          :href="route('transaction_spreadsheet.index')"
                        >
                          Spreadsheet view
                        </DropdownLink>
                ...
                <div :class="classesContact">
                  <Link :class="btnSetup" :href="route('contact.index')"
                    >Contacts</Link
                  >
                </div>
                  ...
                  <div :class="classesReports">
                    <Dropdown align="right" width="48">
                      ...
                      <template #content>
                        ...
                        <DropdownLink
                          :href="route('transport_transaction.index')"
                        >
                          Report Exporter
                        </DropdownLink>
