...
let tableStats = ref("Showing page " + props.transporters.current_page + "  of " + props.transporters.total + " entries.");
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="m-2 p-2">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Transporter Data</h2>
                        ...
                        <div>
                            ...
                            <div class="bg-white rounded-md shadow overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                                    ...
                                    <tr @click="edit(transporter.id)"  v-for="(transporter, index) in transporters.data"
                                        :key="transporter.id" class="hover:bg-gray-100 focus-within:bg-gray-100 ">
                                        ...
                                        <td class="py-4 px-6 whitespace-nowrap">
                                            {{ transporter.id_reg_no }}
                                        </td>
                                        <td class="py-4 px-6 whitespace-nowrap">

                                            <div v-if="transporter.is_active === 1">
                                        ...
                                        <td class="py-4 px-6 whitespace-nowrap">
                                            <span class="inline-flex items-center rounded-full bg-indigo-50 px-2 py-1 text-xs font-medium text-indigo-700 ring-1 ring-inset ring-indigo-700/10"> {{transporter.trades_count}}</span>

                                        </td>


                                        <td class="py-4 px-6 whitespace-nowrap">
                                            <Link class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" :href="route('transporter.show',transporter.id)" >View</Link>
                                        </td>
                        ...
                        <div v-if="transporters.data.length" class="w-full flex justify-center mt-5 mb-4">

                            <PaginationModified :links="transporters.links"/>
