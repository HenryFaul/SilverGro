...
<template>
  <AppLayout title="Customer">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Report Generator</h2>
    </template>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <InputError
                          class="mt-2"
                          :message="customReportForm.errors.name" />
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <div class="sm:col-span-2">
                        ...
                        <InputError
                          class="mt-2"
                          :message="customReportForm.errors.comment" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="">
              ...
              <div class="w-72">
                <div
                  ...
                  class="mt-2">
                  <select
                    v-model="customReportModelForm.report_id"
              ...
              <div class="mt-3 w-72">
                <div
                  ...
                  class="mt-2">
                  <select
                    v-model="customReportModelForm.class_name"
              ...
              <div class="mt-3 w-72">
                <div
                  ...
                  class="mt-2">
                  <select
                    v-model="customReportModelForm.attribute_name"
                    class="mt-2 block w-2/3 rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    <option
