  ...
  <AppLayout title="Transaction">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        ...
        <span class="text-indigo-400">{{ transaction.id }}</span>
      </h2>
    </template>
                  ...
                  <div class="flex col-span-4 mt-2">
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_trans_Form.include_in_calculations
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                    ...
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_trans_Form.is_transaction_done
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
                          ...
                          <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                              ...
                              <p class="mt-2 text-sm text-gray-700">
                                Approvals based on the applied trading rule.
                              </p>
                            </div>
                          </div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="m-2 p-2">
            <div class="">
              ...
              <div class="">
                <div v-if="transaction.contract_type_id === 1">Unallocated</div>
                ...
                <div v-if="transaction.contract_type_id === 3">SC</div>
                  ...
                  <div class="flex col-span-4 mt-2">
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_job_Form.is_multi_loads
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
                    ...
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_job_Form.is_approved
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
                    ...
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_job_Form.is_product_zero_rated
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
                          ...
                          <li
                            ...
                            <div class="flex mt-1">
                              ...
                              <div class="flex-auto font-bold w-3/6">
                                ...
                                {{ n.status_type.type }} on: {{ n.created_at }}
                              </div>
                  ...
                  <div class="flex col-span-4 mt-2">
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_invoice_Form.is_active
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
                    ...
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_invoice_Form.is_printed
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
                    ...
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_invoice_Form.is_invoiced
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
                    ...
                    <SwitchGroup
                      ...
                      <Switch
                        ...
                        :class="[
                          transport_invoice_Form.is_invoice_paid
                            ? 'bg-indigo-600'
                            : 'bg-gray-200',
                          'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2',
                        ]">
