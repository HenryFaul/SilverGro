...
let filter = debounce(() => {
  filterForm.get(route('contact.index'), {
    preserveState: true,
    preserveScroll: true,
  });
}, 150);
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="m-2 p-2">
            ...
            <div class="mb-4 mt-5">
              ...
              >
              <secondary-button @click="clickAdd" class="mt-3 ml-1"
            ...
            <div>
              <div>
                <div
                  v-if="viewWarning"
                  class="rounded-md w-2/3 bg-yellow-50 mb-3 p-4"
                >
                  <div class="flex">
                    ...
                    <div class="ml-3">
                      ...
                      <div class="mt-2 text-sm text-yellow-700">
                        <p>
                          Contacts are added via a specific instance of customer
                          or supplier. Visit a supplier and add a contact.
                        </p>
                        <p>
                          This is done for it to automatically link to that
                          entity.
                        </p>
                      </div>
                    </div>
