<script setup>
  ...
  const emptyErrors = computed(
    () =>
      ...
      contactForm.errors.constructor === Object
  );
  ...
  <AppLayout title="Contact">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        Contact /
        <span class="text-indigo-400">{{ contactForm.last_legal_name }}</span>
      </h2>
    </template>
            ...
            <div class="">
              <form>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <InputError
                          class="mt-2"
                          :message="contactForm.errors.title" />
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                          <input
                            v-model="contactForm.last_legal_name"
                            :disabled="editDisabled"
                            type="text"
                        ...
                        <InputError
                          class="mt-2"
                          :message="contactForm.errors.last_legal_name" />
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <InputError
                          class="mt-2"
                          :message="contactForm.errors.nickname" />
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <InputError
                          class="mt-2"
                          :message="contactForm.errors.id_reg_no" />
                      </div>
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <InputError
                          class="mt-2"
                          :message="contactForm.errors.comment" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                          <input
                            v-model="contactForm.job_description"
                            type="text"
                            :disabled="editDisabled"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                          <InputError
                            class="mt-2"
                            :message="contactForm.errors.job_description" />
                        </div>
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                          <input
                            v-model="contactForm.branch"
                            type="text"
                            :disabled="editDisabled"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                          <InputError
                            class="mt-2"
                            :message="contactForm.errors.branch" />
                        </div>
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                          ...
                          <InputError
                            class="mt-2"
                            :message="contactForm.errors.department" />
                        </div>
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                          ...
                          <InputError
                            class="mt-2"
                            :message="contactForm.errors.is_active" />
                        </div>
                      </div>
                    </div>
                  </div>
                              ...
                              <dl class="divide-y divide-gray-100">
                                <div
                                  ...
                                  <dd
                                    ...
                                    {{ linked_customer.last_legal_name }}
                                  </dd>
                                </div>
                                <div
                                  class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                  ...
                                  <dd
                                    ...
                                    <Link
                                      ...
                                      :href="route('customer.show', linked_customer.id)">
                                      view
                                    </Link>
                                  </dd>
                                </div>
                            ...
                            <div class="mt-6 border-t border-gray-100">
                              <dl class="divide-y divide-gray-100">
                                <div
                                  ...
                                  <dd
                                    class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    {{ linked_supplier.last_legal_name }}
                                  </dd>
                                </div>
                                <div
                                  class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                  ...
                                  <dd
                                    ...
                                    <Link
                                      class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                      :href="route('supplier.show', linked_supplier.id)">
                                      view
                                    </Link>
                                  </dd>
                                </div>
                            ...
                            <div class="mt-6 border-t border-gray-100">
                              <dl class="divide-y divide-gray-100">
                                <div
                                  ...
                                  <dd
                                    class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                    {{ linked_transporter.last_legal_name }}
                                  </dd>
                                </div>
                                <div
                                  class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                  ...
                                  <dd
                                    ...
                                    <Link
                                      class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                      :href="
                                        route('transporter.show', linked_transporter.id)
                                      ">
                                      view
                                    </Link>
                                  </dd>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                  ...
                  <SecondaryButton
                    v-if="!editDisabled && can_update_contact"
                    @click="updateContact"
                    class="m-1">
                    Save
                  </SecondaryButton>
                ...
                <ul class="mt-3">
                  <li
                    ...
                    <div class="flex flex-row">
                      <div class="basis-1/4">
                        <icon
                          v-if="n.contact_detail_type_id === 1"
                          name="phone"
                          class="mr-2 w-6 h-6 fill-green-200" />
                        <icon
                          v-if="n.contact_detail_type_id === 2"
                          name="cell"
                          class="mr-2 w-6 h-6 fill-green-200" />
                        <icon
                          v-if="n.contact_detail_type_id === 3"
                          name="document"
                          class="mr-2 w-6 h-6 fill-green-200" />
                      </div>
