...
import ProductSlideOver from  "@/Components/UI/ProductSlideOver.vue";
...
const viewProductSlideOver = ref(false);

const showProductSlideOver = () => {
    viewProductSlideOver.value = true;
};

const closeProductSlideOver = () => {
    viewProductSlideOver.value = false;
};

let curClient = ref(null);
let showModel = ref(false);

let tableStats = ref("Showing page " + props.products.current_page + "  of " + props.products.total + " entries.");
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="m-2 p-2">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Product Data</h2>
                        ...
                        <div class="mb-4 mt-5">
                            ...
                            <secondary-button @click="showProductSlideOver" class="mt-3 ml-1">Add (+)</secondary-button>
                        </div>
                        <div>

                            <div>
                                <product-slide-over :show="viewProductSlideOver" @close="closeProductSlideOver" />
                            </div>
                            ...
                            <div class="bg-white rounded-md shadow overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                                    ...
                                    <tr @click="edit(product.id)"  v-for="(product, index) in products.data"
                                        :key="products.id" class="hover:bg-gray-100 focus-within:bg-gray-100 ">
                                        ...
                                        <td class="py-4 px-6 whitespace-nowrap">
                                            <Link class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" :href="route('product.show',product.id)" >View</Link>
                                        </td>
                        ...
                        <div v-if="products.data.length" class="w-full flex justify-center mt-5 mb-4">

                            <PaginationModified :links="products.links"/>
