...
const props = defineProps({
  ...
  const card_style =
    'bg-yellow-100 h-36 overflow-hidden shadow-xl sm:rounded-lg p-2 hover:bg-indigo-200 focus-within:bg-indigo-200 overflow-scroll';
  const card_style_cod =
    'bg-orange-300 h-36 overflow-hidden shadow-xl sm:rounded-lg  p-2 hover:bg-indigo-200 focus-within:bg-indigo-200 overflow-scroll';
...
<template>
  <AppLayout title="Diary">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Diary</h2>
    </template>
                  ...
                  <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div v-if="transport_trans.data.length > 0">
                      <table class="min-w-full">
                        ...
                        <tbody class="text-sm">
                          <tr
                            v-for="trans in transport_trans.data"
                            :key="trans.id">
                                ...
                                <div class="flex">
                                  <div class="">
                                    ...
                                    <div class="mt-1 font-bold">
                                      <span>Invoice:</span>
                                      <span>
                                        {{ trans.transport_invoice_details.invoice_no }}
                                      </span>
                                    </div>
                                    <div class="mt-1 font-bold">
                                      <div
                              ...
                              <div
                                ...
                                <div class="flex">
                                  <div class="basis-3/4">
                                    ...
                                    <div class="mt-1">
                                      <div class="flex">
                                        ...
                                        <div class="basis-1/4 whitespace-nowrap">
                                          {{
                                            NiceNumber(
                                              trans.transport_finance.cost_price_per_ton
                                            )
                                          }}
                                        </div>
                                    ...
                                    <div class="mt-1">
                                      <span class="font-bold">Loading hours:</span>
                                      <span v-if="trans.transport_job.loading_hours_from">
                                        {{ trans.transport_job.loading_hours_from.name }}
                                      </span>
                                      <span
                                        v-if="
                                          trans.transport_job.loading_hours_from &&
                                          trans.transport_job.loading_hours_to
                                        "
                                        class="font-bold">
                                        to
                                      </span>
                                      <span v-if="trans.transport_job.loading_hours_to">
                                        {{ trans.transport_job.loading_hours_to.name }}
                                      </span>
                                    </div>
                                    <div
                              ...
                              <div :class="card_style">
                                <div class="flex">
                                  <div class="basis-3/4">
                                    ...
                                    <div class="mt-1">
                                      <div class="flex">
                                        ...
                                        <div class="basis-1/2 ml-6">
                                          ...
                                          <div v-else>
                                            {{
                                              trans.transport_finance.weight_ton_outgoing
                                            }}
                                            Tons
                                          </div>
                                        </div>
                                    ...
                                    <div class="mt-1">
                                      <span class="font-bold">Offloading hours:</span>
                                      <span
                                        v-if="trans.transport_job.offloading_hours_from">
                                        {{
                                          trans.transport_job.offloading_hours_from.name
                                        }}
                                      </span>
                                      <span
                                        v-if="
                                          trans.transport_job.offloading_hours_from &&
                                          trans.transport_job.offloading_hours_to
                                        "
                                        class="font-bold">
                                        to
                                      </span>
                                      <span
                                        v-if="trans.transport_job.offloading_hours_to">
                                        {{ trans.transport_job.offloading_hours_to.name }}
                                      </span>
                                    </div>
                                    <div
