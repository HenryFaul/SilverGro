...
const niceWeighUpOrOutgoing = (trans) => {
  let weighBridgeUpload = totalWeighBridgeUpload(
...
const niceWeighOffOrOutgoing = (trans) => {
  let weighBridgeOffload = totalWeighBridgeOffload(
    trans.transport_driver_vehicle
  );
                    ...
                    <div v-if="transport_trans.data.length > 0">
                                ...
                                <div class="flex">
                                  <div class="">
                                    ...
                                    <div class="mt-3 font-bold">
                                      ...
                                      <span>{{
                                        NiceNumber(
                                          trans.transport_finance.gross_profit
                                        )
                                      }}</span>
                                    </div>
                                  ...
                                  <div class="basis-3/4">
                                    ...
                                    <div class="mt-1">
                                      <div class="flex">
                                        ...
                                        <div
                                          class="basis-1/4 whitespace-nowrap"
                                        >
                                          {{
                                            NiceNumber(
                                        ...
                                        <div
                                          class="basis-1/4 ml-3 whitespace-nowrap"
                                        >
                                ...
                                <div class="flex">
                                  <div class="basis-3/4">
                                    ...
                                    <div class="mt-1">
                                      <div class="flex">
                                        <div
                                          class="basis-1/2 whitespace-nowrap"
                                        >
                                          {{
                                            NiceNumber(
                                              trans.transport_finance
                                  ...
                                  <div class="basis-3/4">
                                    <div class="flex">
                                      ...
                                      <div class="font-bold basis-1/4">
                                        <div
                                          v-if="trans.transport_driver_vehicle"
                                        >
                                          <div
                      ...
                      <table class="ml-3 w-2/3 mt-5 divide-y divide-gray-300">
                        ...
                        <tbody class="divide-y divide-gray-200">
                          <tr
                            class="hover:bg-indigo-200 focus-within:bg-indigo-200"
                          >
                            <td
