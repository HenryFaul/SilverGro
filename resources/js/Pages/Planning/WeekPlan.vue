  ...
  <AppLayout title="Weekly View">
    ...
    <div class="py-1">
      <div class="max-w-10xl mx-auto sm:px-3 lg:px-4">
        <div
          class="bg-gray-50 overflow-hidden shadow-xl sm:rounded-lg min-h-600"
        >
                ...
                <div class="flex">
                  <div class="relative flex items-start">
                    ...
                    <div class="ml-3 text-sm leading-6">
                      <label for="mon" class="font-medium text-gray-900"
                        >Mon</label
                      >
                    </div>
                  </div>
                  <div class="relative ml-2 flex items-start">
                    ...
                    <div class="ml-3 text-sm leading-6">
                      <label for="tue" class="font-medium text-gray-900"
                        >Tue</label
                      >
                    </div>
                  </div>
                  <div class="relative ml-2 flex items-start">
                    ...
                    <div class="ml-3 text-sm leading-6">
                      <label for="wed" class="font-medium text-gray-900"
                        >Wed</label
                      >
                    </div>
                  </div>
                  <div class="relative ml-2 flex items-start">
                    ...
                    <div class="ml-3 text-sm leading-6">
                      <label for="thu" class="font-medium text-gray-900"
                        >Thu</label
                      >
                    </div>
                  </div>
                  <div class="relative ml-2 flex items-start">
                    ...
                    <div class="ml-3 text-sm leading-6">
                      <label for="fri" class="font-medium text-gray-900"
                        >Fri</label
                      >
                    </div>
                  </div>
                  <div class="relative ml-2 flex items-start">
                    ...
                    <div class="ml-3 text-sm leading-6">
                      <label for="sat" class="font-medium text-gray-900"
                        >Sat</label
                      >
                    </div>
                  </div>
                  <div class="relative ml-2 flex items-start">
                    ...
                    <div class="ml-3 text-sm leading-6">
                      <label for="sun" class="font-medium text-gray-900"
                        >Sun</label
                      >
                    </div>
                  </div>
                            ...
                            >
                              <td class="py-4 px-6">
                                ...
                                <div v-if="trans.transport_status.length > 0">
                                  <base-tooltip
                                    :content="
                                      warningLister(trans.transport_status)
                                    "
                                  >
                                    <icon
                                      name="triangle"
                              ...
                              <td class="py-4 px-6">
                                <div v-if="trans.transport_driver_vehicle">
                                  ...
                                  >
                                    <div
                                      v-if="item.is_delivered || item.is_loaded"
                                    >
                              ...
                              <td class="py-4 px-6 whitespace-nowrap">
                                ...
                                >
                                  {{
                                    NiceNumber(
                                      trans.transport_finance.cost_price
                                    )
                                  }}
                                </div>
                              </td>
                              ...
                              <td class="py-4 px-6 whitespace-nowrap">
                                ...
                                <div v-else>
                                  {{
                                    NiceNumber(
                                      trans.transport_finance.selling_price
                                    )
                                  }}
                                </div>
                              </td>
                              ...
                              <td class="py-4 px-6 whitespace-nowrap">
                                {{
                                  NiceNumber(
                                    trans.transport_finance.gross_profit_per_ton
                                  )
                                }}
                              </td>
                            </tr>
