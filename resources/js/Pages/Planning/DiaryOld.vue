...
const nicWeighOrOutgoing = (trans) => {
                                                                ...
                                                                <div class="basis-3/4">
                                                                    ...
                                                                    <div class="mt-1">
                                                                        <div class="flex">
                                                                            ...
                                                                            <div class="basis-1/4">
                                                                                <div v-if="totalWeighBridgeOffload(trans.transport_driver_vehicle) >0">
                                                                                    {{totalWeighBridgeOffload(trans.transport_driver_vehicle)}}
                                                                                </div>
                                                                                <div v-else>
