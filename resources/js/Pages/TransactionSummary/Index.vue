...
let updateSelectValues = () => {
  ...
  transport_approval_Form.deal_ticket_id =
    props.selected_transaction.deal_ticket.id;
  ...
  combined_Form.transaction_notes =
    props.selected_transaction.transaction_notes;
  ...
  combined_Form.is_transaction_done =
    props.selected_transaction.is_transaction_done;
  ...
  combined_Form.is_split_load_member =
    props.selected_transaction.is_split_load_member;
  ...
  combined_Form.delivery_note =
    props.selected_transaction.transport_load.delivery_note;
  ...
  //Purchase Order
  purchaseOrder_Form.transport_trans_id =
    props.purchase_order.transport_trans_id;
  purchaseOrder_Form.confirmed_by_type_id =
    props.purchase_order.confirmed_by_type_id;
  ...
  transportOrder_Form.transport_trans_id =
    props.transport_order.transport_trans_id;
  transportOrder_Form.confirmed_by_type_id =
  ...
  combined_Form.is_approved =
    props.selected_transaction.transport_job.is_approved;
  ...
  combined_Form.number_loads =
    props.selected_transaction.transport_job.number_loads;
  ...
  combined_Form.adjusted_gp =
    props.selected_transaction.transport_finance.adjusted_gp;
  ...
  combined_Form.is_active =
    props.selected_transaction.transport_invoice.is_active;
  combined_Form.is_printed =
    props.selected_transaction.transport_invoice.is_printed;
            ...
            <div class="mt-3 flow-root">
              <div class="-mx-4 -my-4 sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle">
                  <div
                    class="ml-4 grid grid-cols-1 gap-x-6 gap-y-1 sm:grid-cols-6"
                  >
                      ...
                      <div class="flex ml-6">
                        <div class="relative flex items-start">
                          ...
                          <div class="ml-3 text-sm leading-6">
                            <label class="font-medium text-gray-900" for="mon"
                              >Mon</label
                            >
                          </div>
                        </div>
                        <div class="relative ml-2 flex items-start">
                          ...
                          <div class="ml-3 text-sm leading-6">
                            <label class="font-medium text-gray-900" for="tue"
                              >Tue</label
                            >
                          </div>
                        </div>
                        <div class="relative ml-2 flex items-start">
                          ...
                          <div class="ml-3 text-sm leading-6">
                            <label class="font-medium text-gray-900" for="wed"
                              >Wed</label
                            >
                          </div>
                        </div>
                        <div class="relative ml-2 flex items-start">
                          ...
                          <div class="ml-3 text-sm leading-6">
                            <label class="font-medium text-gray-900" for="thu"
                              >Thu</label
                            >
                          </div>
                        </div>
                        <div class="relative ml-2 flex items-start">
                          ...
                          <div class="ml-3 text-sm leading-6">
                            <label class="font-medium text-gray-900" for="fri"
                              >Fri</label
                            >
                          </div>
                        </div>
                        <div class="relative ml-2 flex items-start">
                          ...
                          <div class="ml-3 text-sm leading-6">
                            <label class="font-medium text-gray-900" for="sat"
                              >Sat</label
                            >
                          </div>
                        </div>
                        <div class="relative ml-2 flex items-start">
                          ...
                          <div class="ml-3 text-sm leading-6">
                            <label class="font-medium text-gray-900" for="sun"
                              >Sun</label
                            >
                          </div>
                        </div>
        ...
        <div>
          <div class="px-2 sm:px-3 lg:px-4">
            <div>
                ...
                <div class="md:flex md:items-center md:justify-between">
                  <h3 class="text-base font-semibold leading-6 text-gray-900">
                    ...
                    <div>
                      ...
                      <div
                        class="py-3 ml-2 inline-flex text-sm font-light text-gray-900"
                      >
                  ...
                  <div
                    class="mt-4 flex md:absolute md:right-0 md:top-3 md:mt-0"
                  >
                    <button
              ...
              <div class="m-1 p-1">
                <div class="mb-1" v-if="!emptyErrorsTrans">
                      ...
                      <div class="ml-3">
                        ...
                        <div class="mt-1 ml-6">
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors['confirmed_by_id.id']
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors['confirmed_by_type_id.id']
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors['packaging_incoming_id.id']
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors['packaging_outgoing_id.id']
                            "
                          />
                          <InputError
                            class="mt-2"
                          ...
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors['collection_address_id.id']
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors['delivery_address_id.id']
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors['product_source_id.id']
                            "
                          />
                          ...
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.calculated_route_distance
                            "
                          />
                          ...
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.customer_order_number
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.supplier_loading_number
                            "
                          />
                          <InputError
                            class="mt-2"
                          ...
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.offloading_hours_from_id
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.offloading_hours_to_id
                            "
                          />
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.loading_hours_from_id
                            "
                          />
                          <InputError
                            class="mt-2"
                          ...
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.load_insurance_per_ton
                            "
                          />
                          <InputError
                            class="mt-2"
                          ...
                          <InputError
                            class="mt-2"
                            :message="
                              combined_Form.errors.offloading_instructions
                            "
                          />
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="flex items-start gap-x-2">
                              <input
                                v-model="combined_Form.no_units_incoming"
                                type="number"
                                class="block w-48 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                              />
                            </dd>
                              ...
                              >
                                <div class="relative mt-2">
                                  <ComboboxInput
                                    class="w-48 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    @change="
                                      productSourceQuery = $event.target.value
                                    "
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="flex items-start gap-x-2">
                              <input
                                v-model="combined_Form.product_grade_perc"
                                type="text"
                                class="block w-48 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                              />
                            </dd>
                      ...
                      >
                        ...
                        >
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              <input
                                v-model="combined_Form.no_units_outgoing"
                                type="number"
                                class="block w-48 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                              />
                            </dd>
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="flex items-start gap-x-2">
                              <Combobox
                                as="div"
                                v-model="
                                  combined_Form.billing_units_outgoing_id
                                "
                              >
                                <div class="relative mt-2">
                                  <ComboboxInput
                                  ...
                                  <ComboboxOptions
                                    v-if="
                                      filteredBillingUnitsOutgoing.length > 0
                                    "
                                    class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                  >
                                    <ComboboxOption
                        ...
                        >
                                ...
                                <div class="mt-2">
                                  ...
                                  >
                                    <div class="relative mt-2">
                                      ...
                                      <ComboboxOptions
                                        v-if="
                                          filteredDeliveryAddress.length > 0
                                        "
                                        class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                      >
                                        <ComboboxOption
                              ...
                              <div v-if="combined_Form.delivery_address_id">
                                ...
                                <div class="flex justify-between gap-x-4 py-3">
                                  ...
                                  <dd class="text-gray-700">
                                    <div>
                                      {{
                                        combined_Form.delivery_address_id
                                          .country
                                      }}
                                    </div>
                                  </dd>
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              <div>
                                {{
                                  selected_transaction.customer.terms_of_payment
                                    .value
                                }}
                              </div>
                            </dd>
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              <div>
                                {{
                                  selected_transaction.customer.invoice_basis
                                    .value
                                }}
                              </div>
                            </dd>
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              <div>
                                <check-icon
                                  v-if="
                                    selected_transaction.customer.is_vat_exempt
                                  "
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                          ...
                          >
                                ...
                                >
                                  <div class="relative mt-2">
                                    <ComboboxInput
                                      class="w-80 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                      @change="
                                        customerQuery2 = $event.target.value
                                      "
                                      :display-value="
                                        (customer) => customer?.last_legal_name
                                      "
                                ...
                                <div>
                                  ...
                                  >
                                    <div class="relative mt-2">
                                      ...
                                      <div
                                        v-if="filteredDeliveryAddress2 != null"
                                      >
                                        <ComboboxOptions
                                          v-if="
                                            filteredDeliveryAddress2.length > 0
                                          "
                                          class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                        >
                                          <ComboboxOption
                            ...
                            >
                              <div
                                v-if="
                                  selected_transaction.deal_ticket.is_active
                                "
                              >
                                <div class="text-green-400">
                                  Deal Ticket is Active
                                </div>
                                <div
                                  v-if="selected_transaction.a_mq"
                                ...
                                >
                                  <div class="relative mt-2">
                                    <ComboboxInput
                                      class="w-80 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                      @change="
                                        customerQuery3 = $event.target.value
                                      "
                                      :display-value="
                                        (customer) => customer?.last_legal_name
                                      "
                                ...
                                <div>
                                  ...
                                  >
                                    <div class="relative mt-2">
                                      ...
                                      <div
                                        v-if="filteredDeliveryAddress3 != null"
                                      >
                                        <ComboboxOptions
                                          v-if="
                                            filteredDeliveryAddress3.length > 0
                                          "
                                          class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                        >
                                          <ComboboxOption
                                ...
                                >
                                  <div class="relative mt-2">
                                    <ComboboxInput
                                      class="w-80 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                      @change="
                                        customerQuery4 = $event.target.value
                                      "
                                      :display-value="
                                        (customer) => customer?.last_legal_name
                                      "
                                ...
                                <div>
                                  ...
                                  >
                                    <div class="relative mt-2">
                                      ...
                                      <div
                                        v-if="filteredDeliveryAddress4 != null"
                                      >
                                        <ComboboxOptions
                                          v-if="
                                            filteredDeliveryAddress4.length > 0
                                          "
                                          class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                        >
                                          <ComboboxOption
                                ...
                                >
                                  <div class="relative mt-2">
                                    <ComboboxInput
                                      class="w-80 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                      @change="
                                        customerQuery5 = $event.target.value
                                      "
                                      :display-value="
                                        (customer) => customer?.last_legal_name
                                      "
                                ...
                                <div>
                                  ...
                                  >
                                    <div class="relative mt-2">
                                      ...
                                      <div
                                        v-if="filteredDeliveryAddress5 != null"
                                      >
                                        <ComboboxOptions
                                          v-if="
                                            filteredDeliveryAddress5.length > 0
                                          "
                                          class="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                                        >
                                          <ComboboxOption
                                ...
                                >
                                  <div class="relative mt-2">
                                    <ComboboxInput
                                      class="w-70 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                      @change="
                                        transporterQuery = $event.target.value
                                      "
                                      :display-value="
                                        (transporter) =>
                        ...
                        >
                          <div>
                            <div class="mt-1">
                              ...
                              <InputError
                                class="mt-2"
                                :message="
                                  combined_Form.errors.regular_driver_id
                                "
                              />
                              <div
                                    ...
                                    >
                                      ...
                                      <div class="sm:col-span-2">
                                        ...
                                        <InputError
                                          class="mt-2"
                                          :message="
                                            vehicleForm.errors.vehicle_type_id
                                          "
                                        />
                                      </div>
                                    </div>
                          ...
                          >
                            ...
                            <div class="flex justify-between gap-x-4 py-1">
                              ...
                              <dd class="flex items-start gap-x-2">
                                {{
                                  combined_Form.regular_vehicle_id.vehicle_type
                                    .name
                                }}
                              </dd>
                            </div>
                        ...
                        >
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              <div
                                v-if="
                                  selected_transaction.transporter.contactable
                                "
                              >
                                <div
                                  v-for="contact in selected_transaction
                                    .transporter.contactable"
                                  :key="contact.id"
                                >
                                  <div>
                                    <Link
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              <div
                                v-if="selected_transaction.customer.contactable"
                              >
                                <div
                                  v-for="contact in selected_transaction
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              <div
                                v-if="selected_transaction.supplier.contactable"
                              >
                                <div
                                  v-for="contact in selected_transaction
                                    .supplier.contactable"
                                  :key="contact.id"
                                >
                                  <div>
                                    <Link
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="text-gray-700">
                              {{
                                selected_transaction.transport_load
                                  .no_units_incoming
                              }}
                            </dd>
                          </div>
                        ...
                        >
                          ...
                          <div class="flex justify-between gap-x-4 py-1">
                            ...
                            <dd class="flex items-start gap-x-2">
                              <div>
                                {{
                                  selected_transaction.transporter
                                    .last_legal_name
                                }}
                              </div>
                            </dd>
                          ...
                          <div>
                            <div class="col-span-4">
                              <div class="">
                                <div class="">
                                  <div
                                    class="flex-row text-indigo-400 text-lg mb-2"
                                  >
                          ...
                          <div class="flex justify-between gap-x-4 py-3">
                            ...
                            <dd class="flex items-start gap-x-2">
                              <div>
                                <check-icon
                                  v-if="
                                    selected_transaction.deal_ticket.is_approved
                                  "
                                  class="w-6 h-6 fill-green-300"
                                />
                                <XCircleIcon
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="flex justify-between gap-x-4 py-1">
                            ...
                            <dd class="flex items-start gap-x-2">
                              <div
                                v-if="selected_transaction.transporter_id !== 1"
                              >
                          ...
                          <div v-else>
                            ...
                            <div class="flex justify-between gap-x-4 py-3">
                              <dt class="text-gray-500">
                                Activate Transport Order
                              </dt>
                              <dd class="flex items-start gap-x-2">
                                <SecondaryButton
                                  @click="activateTransportOrder"
                                >
                                  Activate
                                </SecondaryButton>
                              </dd>
                                ...
                                >
                                  <div class="relative mt-2">
                                    <ComboboxInput
                                      class="w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                      @change="
                                        contractTypeQuery = $event.target.value
                                      "
                          ...
                          <div>
                            <div class="">
                              <div class="">
                                <div
                                  v-if="
                                    selected_transaction.contract_type_id === 1
                                  "
                                >
                                  Unallocated
                                </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            lass="text-sm font-medium leading-6 text-gray-900"
                          >
                        ...
                        <form class="">
                          ...
                          >
                            ...
                            <div class="col-span-4">
                              ...
                              >
                                <div
                                  class="ml-5 border-solid p-1 m-1 rounded shadow-xl"
                                >
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                          ...
                          >
                            ...
                            >
                              <div
                                v-if="
                                  n.transport_transaction.is_split_load_primary
                                "
                                class="font-bold text-indigo-400"
                              >
                                <Link
                            ...
                            >
                              <div>
                                {{
                                  n.transport_transaction.customer
                                    .last_legal_name
                                }}
                              </div>
                            </td>
                            ...
                            >
                              <div>
                                {{
                                  n.transport_transaction.transporter
                                    .last_legal_name
                                }}
                              </div>
                            </td>
                            ...
                            >
                              <div>
                                {{
                                  n.transport_transaction.supplier
                                    .last_legal_name
                                }}
                              </div>
                            </td>
