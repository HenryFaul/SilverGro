...
import {EllipsisHorizontalIcon,CheckIcon, ChevronUpDownIcon, PaperClipIcon, XCircleIcon, InformationCircleIcon, ExclamationTriangleIcon, XMarkIcon} from '@heroicons/vue/20/solid';
                            ...
                            <div class="relative border-b border-gray-200 pb-5 sm:pb-0">
                                <div class="md:flex md:items-center md:justify-between">
                                    ...
                                    <div class="mt-3 flex md:absolute md:right-0 md:top-3 md:mt-0">
                                        ...
                                        <button class="ml-3 inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" type="button">Update</button>
                                    </div>
                                </div>
                                <div class="mt-4">
                                        ...
                                        <li  class="overflow-hidden rounded-xl border border-gray-200">
                                            ...
                                            <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="text-gray-700">
                                                        <div>{{selected_transaction.transport_finance.total_cost_price}}</div>
                                                    </dd>
                                                </div>
                                        ...
                                        <li  class="overflow-hidden rounded-xl border border-gray-200">
                                            ...
                                            <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    <dt class="text-gray-500">Payment Terms</dt>
                                                    <dd class="text-gray-700">
                                                        <div>{{selected_transaction.customer.terms_of_payment.value}}
                                        ...
                                        <li  class="overflow-hidden rounded-xl border border-gray-200">
                                            ...
                                            <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="text-gray-700">
                                                        <div>{{selected_transaction.transport_finance.selling_price_per_unit}}</div>
                                                    </dd>
                                                </div>
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="text-gray-700">
                                                        <div>{{selected_transaction.transport_finance.selling_price_per_ton}}</div>
                                                    </dd>
                                                </div>
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="text-gray-700">
                                                        <div>{{selected_transaction.transport_finance.selling_price}}</div>
                                                    </dd>
                                                </div>
                                        ...
                                        <li  class="overflow-hidden rounded-xl border border-gray-200">
                                            ...
                                            <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="text-gray-700">
                                                        {{selected_transaction.transport_finance.total_cost_price}}
                                                    </dd>
                                                </div>
                                        ...
                                        <li  class="overflow-hidden rounded-xl border border-gray-200">
                                            ...
                                            <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="text-gray-700">
                                                        {{selected_transaction.transport_finance.transport_rate_per_ton}}
                                                    </dd>
                                                </div>
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="text-gray-700">
                                                        {{selected_transaction.transport_finance.load_insurance_per_ton}}
                                                    </dd>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                                    ...
                                                    <div class="flex justify-between gap-x-4 py-3">
                                                        ...
                                                        <dd class="text-gray-700">
                                                            <div>{{selected_transaction.transport_finance.cost_price}}</div>
                                                        </dd>
                                                    </div>
                                                    ...
                                                    <div class="flex justify-between gap-x-4 py-3">
                                                        ...
                                                        <dd class="text-gray-700">
                                                            <div>{{selected_transaction.transport_finance.transport_cost}}</div>
                                                        </dd>
                                                    </div>
                                                    ...
                                                    <div class="flex justify-between gap-x-4 py-3">
                                                        ...
                                                        <dd class="text-gray-700">
                                                            <div>{{selected_transaction.transport_finance.gross_profit}}</div>
                                                        </dd>
                                                    </div>
                                                    ...
                                                    <div class="flex justify-between gap-x-4 py-3">
                                                        ...
                                                        <dd class="text-gray-700">
                                                            <div>{{selected_transaction.transport_finance.gross_profit_per_ton}}</div>
                                                        </dd>
                                                    </div>
                                        ...
                                        <li  class="overflow-hidden rounded-xl border border-gray-200">
                                            ...
                                            <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
                                                ...
                                                <div class="flex justify-between gap-x-4 py-3">
                                                    ...
                                                    <dd class="flex items-start gap-x-2">
                                                        <div>
                                                            {{selected_transaction.transport_finance.gross_profit}}
                                                        </div>
                                                    </dd>
                                                </div>
