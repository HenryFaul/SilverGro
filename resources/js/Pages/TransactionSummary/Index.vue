              ...
              <div class="relative border-b border-gray-200 pb-5 sm:pb-0">
                <div class="md:flex md:items-center md:justify-between">
                  <h3 class="text-base font-semibold leading-6 text-gray-900">
                    ...
                    <div>
                      <div
                        v-if="selected_transaction.contract_type?.name === 'MQ' && (selected_transaction.a_mq || selected_transaction.old_deal_ticket)"
                        class="py-2 inline-flex text-xl font-bold text-black">
                        MQ{{ selected_transaction.a_mq ?? selected_transaction.old_deal_ticket }}
                      </div>
                      <div
                        v-if="selected_transaction.contract_type?.name === 'PC' && (selected_transaction.a_pc || selected_transaction.contract_no)"
                        class="py-2 inline-flex text-xl font-bold text-black">
                        PC{{ selected_transaction.a_pc ?? selected_transaction.contract_no }}
                      </div>
                      <div
                        v-if="selected_transaction.contract_type?.name === 'SC' && (selected_transaction.a_sc || selected_transaction.contract_no)"
                        class="py-2 inline-flex text-xl font-bold text-black">
