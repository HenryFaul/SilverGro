...
let tableStats = ref("Showing page " + props.customers.current_page + "  of " + props.customers.total + " entries.");
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="m-2 p-2">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Customer Data</h2>
                        ...
                        <div>
                            ...
                            <div class="bg-white rounded-md shadow overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                                    ...
                                    <tr @click="edit(customer.id)"  v-for="(customer, index) in customers.data"
                        ...
                        <div v-if="customers.data.length" class="w-full flex justify-center mt-5 mb-4">
