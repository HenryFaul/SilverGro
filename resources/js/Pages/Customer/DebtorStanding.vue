          ...
          <div class="m-2 p-2">
            <div class="ml-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
              <div class="flex col-span-6">
                ...
                <secondary-button @click="filter" class="ml-1"
                  >Search</secondary-button
                >
                <secondary-button @click="clear" class="ml-1"
                      ...
                      <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="divide-y divide-gray-200">
                          ...
                          >
                            ...
                            >
                              <div class="font-bold underline">
                                <Link
                                  ...
                                  >{{ invoice.transport_trans_id }}</Link
                                >
                              </div>
                            </td>
                            <td
                            ...
                            >
                              {{
                                invoice.transport_invoice_details
                                  .invoice_pay_by_date
                              }}
                            </td>
                            <td
                            ...
                            >
                              {{
                                NiceNumber(
                                  invoice.transport_invoice_details.outstanding
                                )
                              }}
                            </td>
                            <td
                            ...
                            >
                              {{
                                NiceNumber(
                                  invoice.transport_invoice_details.overdue
                                )
                              }}
                            </td>
                          </tr>
