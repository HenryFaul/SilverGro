...
let Form = useForm({
  ...
  last_legal_name:
    props.staff.staff == null ? '' : props.staff.staff.last_legal_name,
  ...
  job_description:
    props.staff.staff == null ? '' : props.staff.staff.job_description,
...
const addRole = () =>
  roleForm.post(route('roles.modify.store'), {
    preserveScroll: true,
    onSuccess: () => {
...
const can_manage_users = computed(() =>
            ...
            <div class="">
              <form>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                  ...
                  <SecondaryButton
                    v-if="!editDisabled && can_manage_users"
                    @click="updateStaff"
                    class="m-1"
                  >
                    Save
            ...
            <div class="">
              ...
              <div v-if="can_manage_users">
                <div class="col-span-4">
                  ...
                  <InputError
                    class="mt-2"
                    :message="roleForm.errors.role_name"
                  />
                      ...
                      >
                        <div class="flex mt-1">
                          ...
                          <div class="flex-auto font-bold w-2/3">
                            ...
                            <span
                              v-if="n.id > 7"
                              class="inline-flex items-center rounded-md bg-orange-100 px-2 py-1 text-xs font-medium text-purple-700 ring-1 ring-inset ring-purple-700/10"
                              >{{ n.name }}</span
                            >
                          </div>
              ...
              <form class="mt-5">
                <label
                  class="block mb-1 text-gray-500 dark:text-gray-300 font-medium"
                  >Permissions via Roles:</label
                >
                <div class="m-2 p-2 shadow-lg rounded-md">
                  <span
                    v-for="(p, index) in permissions"
                    :key="index"
                    class="inline-flex ml-1 mt-1 items-center rounded-full bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600"
                    >{{ p }}</span
                  >
                </div>
              </form>
