...
let filter = debounce(() => {
  ...
  filterForm.get(route('sc_overview.index'), {
    preserveState: true,
    preserveScroll: true,
    onFinish: (visit) => {
...
let weightRemaining = () => {
  ...
  if (props.linked_trans_other != null) {
    for (let linked of props.linked_trans_other) {
      if (
        linked.transport_transaction.transport_finance.weight_ton_outgoing !=
        null
      ) {
        mq_weight +=
          linked.transport_transaction.transport_finance.weight_ton_outgoing;
  ...
  if (
    props.selected_transaction.transport_finance.weight_ton_outgoing != null
  ) {
    pc_weight =
      props.selected_transaction.transport_finance.weight_ton_outgoing;
  }
...
const getTitle = computed(() => {
  return props.selected_transaction != null
    ? props.selected_transaction.contract_type.name +
            ...
            <div class="mt-3 flow-root">
              <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle">
                  <div
                    class="ml-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6"
                  >
            ...
            <div>
              <div class="relative border-b border-gray-200 pb-5 sm:pb-0">
                <div class="md:flex md:items-center md:justify-between">
                  ...
                  <div
                    class="mt-3 flex md:absolute md:right-0 md:top-3 md:mt-0"
                  ></div>
                </div>
              </div>
              <div class="m-2 p-2">
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="divide-y divide-gray-200">
                        ...
                        >
                          ...
                          >
                            {{
                              contract.transport_transaction.customer
                                .last_legal_name
                            }}
                          </td>
                          <td
                          ...
                          >
                            {{
                              contract.transport_transaction.transporter
                                .last_legal_name
                            }}
                          </td>
                          <td
