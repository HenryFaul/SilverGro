...
let filter = debounce(() => {
  filterForm.get(route('regular_driver.index'), {
    preserveState: true,
    preserveScroll: true,
  });
}, 150);
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="m-2 p-2">
            ...
            <div class="mb-4 mt-5">
              ...
              >
              <secondary-button @click="showDriverSlideOver" class="mt-3 ml-1"
            ...
            <div>
              <div>
                <driver-slide-over
                  :show="viewDriverSlideOver"
                  @close="closeDriverSlideOver"
                />
              </div>
