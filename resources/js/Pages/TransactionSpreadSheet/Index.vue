...
const row_styler = computed(
  () =>
    'whitespace-nowrap border-b bg-white px-3 py-1 text-sm text-gray-500 lg:table-cell'
);
...
let filter = debounce(() => {
  filterForm.get(route('transaction_spreadsheet.index'), {
    preserveState: true,
    preserveScroll: true,
    onFinish: (visit) => {},
  });
...
let updateSelectedTrans = async (_id) => {
  unitForm.selected_trans = props.transactions.data.find(
  ...
  if (unitForm.selected_trans != null) {
    ...
    unitForm.no_units_incoming =
      unitForm.selected_trans.transport_load.no_units_incoming;
    unitForm.no_units_outgoing =
      unitForm.selected_trans.transport_load.no_units_outgoing;
...
const updatePlayers = () => {
  transForm.put(
    route('transport_transaction.update_players', transForm.selected_trans.id),
    {
      preserveScroll: true,
      onSuccess: () => {
        //swal(usePage().props.jetstream.flash?.banner || '');
      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="flow-root">
          <div class="-mx-4 -my-2 sm:-mx-6 lg:-mx-8">
            <div>
              <div
                class="ml-4 shadow-xl mt-3 p-3 bg-white grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6"
              >
                ...
                <div class="col-span-4 flex">
                  <div>
                    ...
                    >
                    <secondary-button class="ml-1" @click="showTradeSlideOver"
              ...
              <table class="min-w-full border-separate border-spacing-0">
                <thead>
                  <tr>
                    ...
                    <th scope="col" :class="header_styler">
                      Customer Order No
                    </th>
                    ...
                    <th v-if="showDetails" scope="col" :class="header_styler">
                      D/T
                    </th>
                    <th v-if="showDetails" scope="col" :class="header_styler">
                      P/O
                ...
                <tbody>
                  <tr
                    v-for="(transaction, transIdx) in transactions.data"
                    :key="transaction.id"
                  >
                    <td
                      :class="[
                    ...
                    >
                      <div
                        v-if="transaction.transport_job.customer_order_number"
                      >
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <span
                              ...
                              {{ driver_vehicle.driver.last_name }}</span
                            >
                          </div>
                          <div>
                            <span>Vehicle: </span>
                    ...
                    <td :class="row_styler">
                      <div v-if="props.all_suppliers != null" class="mt-2">
                        ...
                        <div v-if="transForm.selected_trans != null">
                          <button
                            v-if="
                              transaction.id === transForm.selected_trans.id
                            "
                    ...
                    <td :class="row_styler">
                      {{
                        NiceNumber(
                          transaction.transport_finance.cost_price_per_ton
                        )
                      }}
                    </td>
                    <td :class="row_styler">
                      {{
                        NiceNumber(
                          transaction.transport_finance.selling_price_per_ton
                        )
                      }}
                    </td>
                    <td :class="row_styler">
                      {{
                        NiceNumber(
                          transaction.transport_finance.transport_rate_per_ton
                        )
                      }}
                    </td>
                    <td :class="row_styler">
                      {{
                        NiceNumber(
                          transaction.transport_finance.gross_profit_per_ton
                        )
                      }}
                    </td>
                    <td :class="row_styler">
