...
let customerForm = useForm({
  ...
  terms_of_payment_basis_id:
    props.customer_parent.terms_of_payment_basis_id ?? 1,
  ...
  days_overdue_allowed_id:
    props.customer_parent.days_overdue_allowed_id ?? null,
                      ...
                      <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                          ...
                          >
                            ...
                            <option key="0" value="0">Suspended</option>
                          </select>
                        </div>
                        <InputError
                          class="mt-2"
              ...
              <form class="mt-5">
                ...
                <div>
                  <div class="flex">
                    <ul class="w-1/3">
                      <li
                        v-for="n in customer_parent.staff"
                        :key="n.id"
                        :value="n.id"
              ...
              <form class="mt-5">
                ...
                <div>
                  <div>
                    ...
                    <ul class="w-3/2">
                      <li
                        v-for="n in customer_parent.addressable"
                        :key="n.id"
                        :value="n.id"
                        class="w-full border-b-2 border-neutral-100 border-opacity-100 py-4 dark:border-opacity-50"
                      >
          ...
          <div class="m-2 p-2">
            <div class="">
              ...
              <div class="mt-5">
                ...
                <ul class="w-3/2">
                  <li
                    v-for="n in customer_parent.contactable"
                    :key="n.id"
                    :value="n.id"
                    class="w-full border-b-2 border-neutral-100 border-opacity-100 py-4 dark:border-opacity-50"
                  >
            ...
            <div class="">
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr
                    v-for="(customer, index) in customer_parent.customer"
                    :key="customer.id"
