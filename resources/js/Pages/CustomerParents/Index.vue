...
let tableStats = ref(
  'Showing page ' +
    props.customer_parents.current_page +
    '  of ' +
    props.customer_parents.total +
    ' entries.'
);

let filter = debounce(() => {
  filterForm.get(route('customer_parent.index'), {
    preserveState: true,
    preserveScroll: true,
  });
}, 150);
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="m-2 p-2">
            ...
            <div class="mb-4 mt-5">
              ...
              >
              <secondary-button @click="showCustomerSlideOver" class="mt-3 ml-1"
            ...
            <div>
              <div>
                <customer-slide-over
                  :show="viewCustomerSlideOver"
                  @close="closeCustomerSlideOver"
                />
              </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr
                      ...
                      v-for="(customer, index) in customer_parents.data"
                      :key="customer.id"
                    ...
                    >
                      ...
                      <td class="py-4 px-6 whitespace-nowrap">
                        <Link
                          ...
                          :href="route('customer_parent.show', customer.id)"
                          >View</Link
                        >
                      </td>
                    </tr>
            ...
            <div
              v-if="customer_parents.data.length"
