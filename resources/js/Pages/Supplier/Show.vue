...
const can_update_supplier = computed(() => usePage().props.roles_permissions.permissions.includes("update_supplier"));
                        ...
                        <div class="">
                            <form>
                                ...
                                <div class="space-y-12">
                                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm leading-6 text-gray-600">Static Supplier information.</p>
                                        </div>
                                        ...
                                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                                            ...
                                            <div class="sm:col-span-3">
                                                ...
                                                <div class="mt-2">
                                                    <input v-model="supplierForm.last_legal_name" :disabled="editDisabled" type="text" name="last_legal_name" id="last_legal_name" autocomplete="family-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                </div>
                                            ...
                                            <div class="sm:col-span-3">
                                                ...
                                                <div class="mt-2">
                                                    <input v-model="supplierForm.nickname" type="text" :disabled="editDisabled" name="nickname" id="nickname" autocomplete="nickname" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                                </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm leading-6 text-gray-600">Supplier account information.</p>
                                        </div>
                                ...
                                <div class="mt-6 flex items-center justify-end gap-x-6">
                                    ...
                                    <SecondaryButton v-if="can_update_supplier" class="m-1" @click="toggleEdit">
                                        Edit
                                    </SecondaryButton>

                                    <SecondaryButton v-if="!editDisabled && can_update_supplier" @click="updateSupplier" class="m-1">
                                        Save
                                    </SecondaryButton>
                                </div>
                            </form>
