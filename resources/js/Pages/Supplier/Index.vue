...
import SupplierSlideOver from  "@/Components/UI/SupplierSlideOver.vue";
...
const viewSupplierSlideOver = ref(false);

const showSupplierSlideOver = () => {
    viewSupplierSlideOver.value = true;
};

const closeSupplierSlideOver = () => {
    viewSupplierSlideOver.value = false;
};

let curClient = ref(null);
let showModel = ref(false);

let tableStats = ref("Showing page " + props.suppliers.current_page + "  of " + props.suppliers.total + " entries.");
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="m-2 p-2">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Supplier Data</h2>
                        ...
                        <div class="mb-4 mt-5">
                            ...
                            <secondary-button @click="showSupplierSlideOver" class="mt-3 ml-1">Add (+)</secondary-button>
                        </div>
                        <div>

                            <div>
                                <supplier-slide-over :show="viewSupplierSlideOver" @close="closeSupplierSlideOver" />
                            </div>
                            ...
                            <div class="bg-white rounded-md shadow overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                                    ...
                                    <tr @click="edit(supplier.id)"  v-for="(supplier, index) in suppliers.data"
                                        :key="supplier.id" class="hover:bg-gray-100 focus-within:bg-gray-100 ">
                                        ...
                                        <td class="py-4 px-6 whitespace-nowrap">
                                            <Link class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" :href="route('supplier.show',supplier.id)" >View</Link>
                                        </td>
                        ...
                        <div v-if="suppliers.data.length" class="w-full flex justify-center mt-5 mb-4">

                            <PaginationModified :links="suppliers.links"/>
